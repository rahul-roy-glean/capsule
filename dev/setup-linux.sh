...
echo ""
echo "Next steps:"
echo "  make dev-build-local      # Build binaries + rootfs"
echo "  make dev-stack-local      # Start control-plane + firecracker-manager"
echo "  make dev-test-exec-local  # Run E2E test"
