...
const (
	// ThawAgentHealthPort is the VM-internal port for the thaw-agent health/warmup server.
	// Moved from 8080 to avoid conflicts with user services running inside the VM.
	ThawAgentHealthPort = 10500

	// ThawAgentDebugPort is the VM-internal port for the thaw-agent debug server
